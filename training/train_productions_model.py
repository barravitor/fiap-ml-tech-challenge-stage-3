...
from utils.helpers import slugify, load_data, error_logs, save_trained_model, save_trained_encoder
...
df_filtered = filter_data(df, 20)

encoder = OneHotEncoder(sparse_output=False)

X_train, X_test, y_train, y_test = split_test_and_train(df_filtered)
