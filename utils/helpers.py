...
def load_trained_model(filename):
    return joblib.load(f'./models/productions/{filename}_model_trained.pkl')

def load_trained_encoder(filename):
    return joblib.load(f'./encoders/productions/{filename}_encoder_trained.pkl')